...
# rsync -rlIpz --info=progress2 --temp-dir=~/tmp --delay-updates --ipv4 --exclude=.git -e 'ssh -o "StrictHostKeyChecking=no" -p 2222' './themes/my-theme' 'dev.65401411-429a-476e-8dc8-4bd98e5d9164@appserver.dev.65401411-429a-476e-8dc8-4bd98e5d9164.drush.in:code/wp-content/themes'
